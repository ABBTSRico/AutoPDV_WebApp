...
(function() {
	...
	var JB_tableSort = function(tab,startsort) {
		...
		if(!document.getElementById("JB_stylesheet_tableSort")) {
			...
			stylestring += '.sortsymbol.sortedasc::after { content: "â–²â–½" } ';
			stylestring += '.sortsymbol.sorteddesc::after { content: "â–³â–¼" } ';
			stylestring += '.sortsymbol.unsorted::after { content: "â–³â–½" } '	;
